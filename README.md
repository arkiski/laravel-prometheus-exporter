...
'providers' => [
    // ...
    Barnetik\LaravelPrometheusExporter\PrometheusServiceProvider::class,
]
```
...
'aliases' => [
    // ...
    'Prometheus' => Barnetik\LaravelPrometheusExporter\PrometheusFacade::class,
]
```
...
```bash
php artisan vendor:publish --provider="Barnetik\LaravelPrometheusExporter\PrometheusServiceProvider"
```
...
$exporter = app(\Barnetik\LaravelPrometheusExporter::class);
// or
